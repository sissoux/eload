...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN15 
    */
    HAL_GPIO_DeInit(Vcell5_GPIO_Port, Vcell5_Pin);

    HAL_GPIO_DeInit(GPIOA, Vcell1_Pin|Vcell2_Pin|Vcell3_Pin|Vcell4_Pin);

    HAL_GPIO_DeInit(Vcell6_GPIO_Port, Vcell6_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA7     ------> ADC2_IN4 
    */
    HAL_GPIO_DeInit(Vimeas_GPIO_Port, Vimeas_Pin);
